...
[2017/06/05 v0.01 LaTeX package commande pour la création d'exercice et de question]

\def\hi{Ce paquet permet de définir les commandes exercices et question.}
\let\myDate\date
